...
import framework.db
from models.synology import Base
from api import health, info, synology
...
app = FastAPI(
    title="Synology API",
    version="1.0.0",
    openapi_url="/api/v1/synology/openapi.json",
    docs_url="/api/v1/synology/docs",
    lifespan=lifespan
)
...
app.include_router(synology.router, tags=["synology"])
app.mount("/synology/test", StaticFiles(directory="static", html=True), name="test")
